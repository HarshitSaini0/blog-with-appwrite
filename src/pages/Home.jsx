    ...
    <div className="min-h-screen bg-gray-100">
      <main className="container mx-auto p-4">
        <section className="my-8">
          <h3 className="text-center text-lg sm:text-xl md:text-2xl">Hello {userData ? userData.name : "Guest"}</h3>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center my-8">Welcome to My Blog</h1>
          <blockquote className="text-lg sm:text-xl md:text-2xl italic text-center text-gray-600">
            "The best way to predict the future is to create it." - Peter Drucker
          </blockquote>
        </section>
        <section className="my-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-center">About Us</h2>
        ...
        <section className="my-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-center">Contact Us</h2>
          <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-700 text-center">
